$(document).ready(function(){
    /*--------------------搜索框样式控制js------------------------*/
     var search_types={
        "types":[{name:"https://www.baidu.com/s?wd=",stype:"images/searchChoice/scbaidu.png",type:"baidu"},
                 {name:"https://www.sogou.com/web?query=",stype:"images/searchChoice/scsougou.png",type:"sogou"},
                 {name:"https://cn.bing.com/search?q=",stype:"images/searchChoice/scbing.png",type:"bing"},
                 {name:"https://www.so.com/s?q=",stype:"images/searchChoice/sc360.png",type:"so"},
                 {name:"https://www.google.com/search?q=",stype:"images/searchChoice/scgoogle.png",type:"google"},
                 {name:"http://www.cilimao.cc/search?word=",stype:"images/searchChoice/sccili.png",type:"cili"},
                 {name:"http://neets.cc/search?key=",stype:"images/searchChoice/scyingyin.png?v=1.1",type:"yingyin"},                 
                 {name:"http://www.somelemon.com/index.php?r=l&kw=",stype:"images/searchChoice/scyouhui.png",type:"youhui"}
                ]};
